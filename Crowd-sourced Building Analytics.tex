...
\begin{document}
    ...
    \chapter{Problem Analysis}
		...
		\textcolor{red}{Does this need any more of a wrap up? Are there any points I have missed?}
    ...
    \label{chap:method}
        ...
        \label{sec:sysspec}
            ...
            \textcolor{red}{How to segue from specification to implementation? Crude to just say ``with the system now specified the implementation can begin''}
        ...
        \label{sec:dataprep}
			...
			\begin{itemize}
				...
				\end{itemize}
				\item Implementation of ground truth RGEA for evaluation (mention scale to local area) (noticable speed difference because only comparing the 3 parameters) (1)
				...
				\end{itemize}
				\item \textcolor{red}{Simplified RGEA compares only those where the strongest RSSIs were of the same APs. Massive speed gains as only comparing similar number of parameters to ground truth (also sparse). (2)}
			\end{itemize}
        ...
        \label{sec:modelcreation}
            ...
            \subsection{Off-line Learning}
                ...
                \begin{itemize}
                    ...
                    \begin{itemize}
                        \item Explain why using 2D subspace - simplicity, existing techniques proven effective on these spaces, also allows space scaling (can model all 3 buildings simultaneously or just 1) \textcolor{blue}{Mention possibility of 3D!}
