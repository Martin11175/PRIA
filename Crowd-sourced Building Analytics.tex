...
\begin{document}
    ...
    \label{chap:eval}
		...
		\begin{itemize}
            ...
            \item \textcolor{blue}{RGEA evaluations: RGEA pessimistic, Heuristic optimistic. On further inspection though, a number of those ifentified as false positives had differences of 2dB between the same three APs identified as strongest, but the measurements were taken a whole floor and over 10m laterally apart!}
		\end{itemize}
