	...
	\chapter{Method}
		...
		\section{Data Preparation}
			...
			\begin{itemize}
				...
				\item System of linear equations ($1k_i + 1k_j = V_ij$), underspecified for number of gains to be solved, but simulated annealing performs far worse (and modifies irrelevant parameters). Determines MSE and prioritised initially by \texttt{sigma\_deltaG}, but this causes exponential increase in priority for very little increase in probability through bell curve.
